...
replace github.com/gptscript-ai/go-gptscript => github.com/StrongMonkey/go-gptscript v0.0.0-20240702233538-9e249844929c
...
require (
	...
	github.com/gptscript-ai/gptscript v0.8.5
